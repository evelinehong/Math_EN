...
class DataLoader():
    def __init__(self, args, emb_dim=128):
        self.args = args
        self.math23k_train_list = read_data_json("./data/train23k_processed_sorted.json")
        self.math23k_valid_list = read_data_json("./data/valid23k_processed_sorted.json")
        self.math23k_test_list = read_data_json("./data/test23k_processed_sorted.json")
    ...
    def _shuffled_batch(self, batch_data_dict):
        new_batch_data_dict = dict()
        sort_idx = list(range(len(batch_data_dict['batch_index'])))
